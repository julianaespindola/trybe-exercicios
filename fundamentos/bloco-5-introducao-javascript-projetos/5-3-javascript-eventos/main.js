...
const mygit = document.getElementById('my-spotrybefy');
...
mygit.addEventListener('dblclick', function(){
    window.location.replace('https://github.com/julianaespindola/julianaespindola.github.io');
});
...
mygit.addEventListener('mouseover',function(event){
    event.target.style.color = 'red';
})

mygit.addEventListener('mouseout', function(event){
